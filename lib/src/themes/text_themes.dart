...
class TextThemes {
  ...
  static TextStyle get _redSubtitle2 => _poppinsTextTheme.subtitle1!
      .copyWith(color: Colors.red, fontSize: 12.0, fontWeight: FontWeight.bold);
